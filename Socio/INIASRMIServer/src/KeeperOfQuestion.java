 ...
 */
public class KeeperOfQuestion extends UnicastRemoteObject implements Keeper {
    ...
    public KeeperOfQuestion(INIACRMIInterface aServer) throws java.rmi.RemoteException  {
        Server          =   aServer;
