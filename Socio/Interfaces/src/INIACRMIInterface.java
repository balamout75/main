 ...
 *
 * Created on 6 ßíâàðü 2004 ã., 14:19
*/
...
public interface INIACRMIInterface extends Remote, Serializable {
    ...
    public void         StoreDQÀ(DQAInterface DQA, int type) throws RemoteException;
    public RInterface   getDMIRootPointer() throws RemoteException;    
    
    
    //public void         DQÀStore(Integer ID, int type) throws RemoteException;
