...
public class DictionaryEditorPanel extends javax.swing.JPanel {
    ...
    public DictionaryEditorPanel(Library aLib, INIACRMIInterface aServer) {
	try
	{
            Server = aServer;
            initComponents();
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder("Рабочий словарь"));
    ...
    public void setDictionary(DictionaryInterface aDI) throws RemoteException{
        if ((DI==null)||(!aDI.equals(DI))) {
            DI=aDI;
            makeTree();
        }
    }
    ...
    private void makeAnswerBranches(DefaultMutableTreeNode top,RInterface RQI) {
        try {
            ...
            AM=new AnswerMark(null,null,RQI);
            AM.setLocalPos(QI.getSize()+1);
            DefaultMutableTreeNode root=new DefaultMutableTreeNode(AM);
            top.add(root);
        } catch(Exception re ) {
    ...
    private void makeTree() {
        try {
            DefaultMutableTreeNode top = new DefaultMutableTreeNode(new DictionaryMark(DI));
    ...
    private void OpenEditForm() {
        ...
        try {
            ...
            //Lib.OpenEditForm(Data.getDMI(),null);
        } catch( Exception re ) {
