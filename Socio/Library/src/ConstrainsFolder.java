...
public class ConstrainsFolder extends javax.swing.JPanel {
    ...
    public ConstrainsFolder (Library aLib) {
        try  {
            makeTree();
            initComponents();
            Lib = aLib;
    ...
    private void makeTree() {
        try {
            ...
            DefaultMutableTreeNode top = new DefaultMutableTreeNode(new String("Свойства папки"));
