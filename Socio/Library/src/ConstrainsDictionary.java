...
public class ConstrainsDictionary extends javax.swing.JPanel {
    ...
    public ConstrainsDictionary (Library aLib) {
        try  {
            makeTree();
            initComponents();
            Lib = aLib;
    ...
    private void makeAnswerBranches(DefaultMutableTreeNode top) {
        try {
            top.add(new DefaultMutableTreeNode(new String("Наименование")));
        } catch(Exception re ) {
    ...
    private void makeTree() {
        try {
            ...
            DefaultMutableTreeNode top = new DefaultMutableTreeNode(new String("Свойства словаря"));
